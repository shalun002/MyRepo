...
int main(){
	...
	cout << "min " << getFuncArrMin(arr, 10) << endl; // вывод в консоль шаблонной функции для поиска минимума.
	cout << "max " << getFuncArrMax(arr, 10) << endl; // вывод в консоль шаблонной функции для поиска максимума.

	// функция сортировки
	bubbleSort(arr, 10);  // 10 - размер массива, arr - сам массив.

	// вызываем функцию и передаем ей параметры (arr, 5, 10)
	SearchArrayElement(arr, 4, 10);		// 10 - размер массива, 5 - число, которое нужно найти в массиве		
